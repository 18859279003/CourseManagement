...
public class GroupController {
	...
	public SeminarGroupTopic getTopicById(@PathParam("groupId") Integer groupId, boolean embedTopics, boolean embedGrade){
    ...
    @ResponseStatus(value=HttpStatus.NO_CONTENT)
    public void remvoe(@PathParam("classId") Integer classId, @RequestBody User student){
    }
    ...
    public String chooseTopic(@PathParam("groupId") Integer groupId, Topic topic){
...
*/	
	...
	@ResponseStatus(value=HttpStatus.NO_CONTENT)
	public void gradeByGroupId(@PathParam("groupId") Integer groupId, String reportGrade){//TODO
	}
