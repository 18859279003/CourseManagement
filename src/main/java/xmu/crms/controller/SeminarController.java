...
public class SeminarController {
    ...
    public SeminarGroup getStudentSeminarById(@PathVariable("seminarId") int seminarId, int studentId) throws IllegalArgumentException, GroupNotFoundException{
        return seminarGroupImpl.getSeminarGroupById(new BigInteger(seminarId+""), new BigInteger(studentId+""));
    }	
