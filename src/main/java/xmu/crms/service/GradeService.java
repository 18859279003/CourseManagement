...
public interface GradeService {
	 ...
	 * 按ID设置小组报告分.
	 *
	 * @param seminaGroupId 讨论课组id
	 * @param grade            分数
	 * @throws GroupNotFoundException   未找到小组
	 * @throws IllegalArgumentException seminar_group_id或grade格式错
	 */
	void updateGroupByGroupId(BigInteger seminaGroupId, BigInteger grade)
			throws GroupNotFoundException, IllegalArgumentException;
